...
inventorNames = inventors.map((inventors) => {return {first:inventors.first,last:inventors.last}})
...
firstLast = people.map (people => {const [lastName,firstName]=people.split(','); return `${firstName} ${lastName}`;})
...
/****** Worked together with Alfred, Tanner, Will, Azalea *******/
